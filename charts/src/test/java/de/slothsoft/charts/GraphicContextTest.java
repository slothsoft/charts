...
public class GraphicContextTest {
	...
	public void testScale() throws Exception {
		...
		Assert.assertEquals(Arrays.asList("scale(4.2, 4.2)"), this.graphicContext.log);
	}
	...
	public void testFillRectangle() throws Exception {
		...
		Assert.assertEquals(Arrays.asList("fillRectangle(1.2, 3.4, 3.3, 3.4)"), this.graphicContext.log);
	}
}
